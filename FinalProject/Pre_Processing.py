...
Text = []
I=1
with open('C:\\Users\\joshu\\Desktop\\Stats\\STATS101C\\FinalProject\\Data_Final.json', 'r',encoding='UTF-8') as f:
    for line in f:
        I += 1
        #if I==3:
           # break
...
DF_Final.Review = pd.read_csv("C:\\Users\\joshu\\Desktop\\Stats\\STATS101C\\FinalProject\\Data_Final.csv")
X = DF_Final.Review
...
#------------------------------------Sentiment Lexicon------------------------------------------\
f_n = open("C:\\Users\\joshu\\Desktop\\Stats\\STATS101C\\FinalProject\\negative-words.txt", "r")
Negative_words = f_n.readlines()
f_p = open("C:\\Users\\joshu\\Desktop\\Stats\\STATS101C\\FinalProject\\positive-words.txt", "r")
